---
name: taskboard
description: Work through GitHub issues assigned to you and PRs requesting your review via the harness taskboard and organisation identity.
---
...
1. Prefer the sidebar **任务面板**. Opening it while logged out starts GitHub device login in the panel (no chat tool).
